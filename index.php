        ...
        <div class="audio-samples">
            <ul>
                <li>
                    ...
                    <audio controls src="https://piercew25.github.io/NikkiGustiVO/audio/Nikki_Gusti_C3 (1).mp3"></audio>
                </li>
                <li>
                    <p>Soothing, Conversational, and Warm </p>
                    <audio controls src="https://piercew25.github.io/NikkiGustiVO/audio/Nikki_Gusti_N3.mp3"></audio>
                </li>
            </ul>
        </div>
