...
<html>
    <head>
        <title>Nikki Gusti Voice Actor</title>
        ...
        <h2>Listen for the Wow!</h2>
        <div class="audio-samples">
            <ul>
                <li>
                    <p>An Engaging, Charismatic, & Soothing Voice Over Talent</p>
                    <audio controls src="https://piercew25.github.io//NikkiGustiVO-main/audio/Nikki_Gusti_C3 (1).mp3"></audio>
                </li>
                <li>
                    <p>Soothing, Conversational, and Warm </p>
                    <audio controls src="https://piercew25.github.io//NikkiGustiVO-main/audio/Nikki_Gusti_N3.mp3"></audio>
                </li>
            </ul>
        </div>
        ...
        <form class="email-me" method="POST" action="https://formsubmit.co/your@email.com">
            <h2>Contact Me!</h2>
            <br>
            ...
            <br>
            <textarea id="message" name="message" placeholder="Message" rows="4" cols="0">Message</textarea>
